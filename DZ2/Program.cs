...
int LargeValueCounter(int[] col, int value)
{
    int count = 0;
...
int[] SelectElements(int[] coll, int count, int value)
{
...
int[] coll = FillArray(15, 1, 25);
ShowCollection(coll);
Console.WriteLine();
int count = LargeValueCounter(coll, 8);
int[] coll2 = SelectElements(coll, count, 8);
